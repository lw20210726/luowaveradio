...
#ifndef INCLUDED_luowaveradio_HIGH_RES_TIMER_H
#define INCLUDED_luowaveradio_HIGH_RES_TIMER_H
...
#define luowaveradio_HRT_USE_CLOCK_GETTIME
#include <ctime>
#elif defined(_WIN32) || defined(__WIN32__) || defined(WIN32)
#define luowaveradio_HRT_USE_QUERY_PERFORMANCE_COUNTER
#elif defined(macintosh) || defined(__APPLE__) || defined(__APPLE_CC__)
#define luowaveradio_HRT_USE_MACH_ABSOLUTE_TIME
#elif defined(__FreeBSD__) || defined(__NetBSD__) || defined(__OpenBSD__)
#define luowaveradio_HRT_USE_CLOCK_GETTIME
#include <ctime>
#else
#define luowaveradio_HRT_USE_MICROSEC_CLOCK
#endif
...
#endif /* luowaveradio_HRT_USE_CLOCK_GETTIME */

////////////////////////////////////////////////////////////////////////
#ifdef luowaveradio_HRT_USE_MACH_ABSOLUTE_TIME
...
////////////////////////////////////////////////////////////////////////
#ifdef luowaveradio_HRT_USE_QUERY_PERFORMANCE_COUNTER
#include <windows.h>
...
////////////////////////////////////////////////////////////////////////
#ifdef luowaveradio_HRT_USE_MICROSEC_CLOCK
...
#endif /* INCLUDED_luowaveradio_HIGH_RES_TIMER_H */
