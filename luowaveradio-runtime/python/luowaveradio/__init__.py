...
# This file makes luowaveradio a package
# The docstring will be associated with the top level of the package.

import os

# Check if the luowaveradio package is installed or whether we're attempting to import it from
# the build directory.
path_ending = os.path.join('luowaveradio-runtime', 'python', 'luowaveradio', '__init__.py')
...
if path.endswith(path_ending):
    ...
    # part of the luowaveradio package.
